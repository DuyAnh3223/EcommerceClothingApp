...
class _BuyCoinScreenState extends State<BuyCoinScreen> {
  ...
  Widget build(BuildContext context) {
    int total = selected.entries.fold(0, (sum, e) => sum + (e.value * (packages.firstWhere((p) => p.id == e.key).price)));
    int discount = 0; // Tính khuyến mãi nếu có
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text('BA $total', style: TextStyle(fontWeight: FontWeight.bold)),
                                ],
                              ),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
