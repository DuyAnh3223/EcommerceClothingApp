...
class _AttributeManagerScreenState extends State<AttributeManagerScreen> {
  ...
  Future<void> _loadAttributes() async {
    ...
    final res = await http.get(Uri.parse('http://127.0.0.1/EcommerceClothingApp/API/admin/variants_attributes/get_attributes.php'));
  ...
  Future<void> _loadAttributeValues(int attributeId) async {
    setState(() { isLoading = true; });
    final res = await http.get(Uri.parse('http://127.0.0.1/EcommerceClothingApp/API/admin/variants_attributes/get_attribute_values.php?attribute_id=$attributeId'));
    final data = json.decode(res.body);
    if (data['success'] == true) {
      setState(() {
  ...
  Future<void> _addAttribute() async {
    ...
    final response = await http.post(
      Uri.parse('http://127.0.0.1/EcommerceClothingApp/API/admin/variants_attributes/add_attribute.php'),
  ...
  Future<void> _deleteAttribute(int attributeId) async {
    final res = await http.delete(
      Uri.parse('http://127.0.0.1/EcommerceClothingApp/API/admin/variants_attributes/delete_attribute.php'),
      headers: {'Content-Type': 'application/json'},
  ...
  Future<void> _addAttributeValue() async {
    ...
    final res = await http.post(
      Uri.parse('http://127.0.0.1/EcommerceClothingApp/API/admin/variants_attributes/add_attribute_value.php'),
      headers: {'Content-Type': 'application/json'},
  ...
  Future<void> _deleteAttributeValue(int valueId) async {
    final res = await http.delete(
      Uri.parse('http://127.0.0.1/EcommerceClothingApp/API/admin/variants_attributes/delete_attribute_value.php'),
      headers: {'Content-Type': 'application/json'},
